...
class ConvolNetSpatial(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=20, kernel_size=(1,2), stride=1, padding=1)
        # with torch.no_grad():
        #     self.conv1.weight.masked_scatter_ = torch.ones([20,1,5,1])
        self.conv2 = nn.Conv2d(in_channels=20, out_channels=10, kernel_size=(5,1), stride=1, padding=1)
        self.conv2_drop = nn.Dropout2d()
