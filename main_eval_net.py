...
train_loader, valid_loader = load_data(data_dir, first_4_col_names, first_4_columns)
...
evaluate(train_loader, device, model_dir)
evaluate(valid_loader, device, model_dir)
